...
/// Signature for the callback that's called when when the monthyear.dart menu opens or closes.
...
///
/// A monthyear.dart button lets the user select from a number of items. The button
...
///
/// The type `T` is the type of the value that each monthyear.dart item represents.
/// All the entries in a given menu must represent values with consistent types.
/// Typically, an enum is used. Each [DropdownItem] in [items] must be
/// specialized with that same type argument.
///
/// The [onChanged] callback should update a state variable that defines the
/// monthyear.dart's value. It should also call [State.setState] to rebuild the
/// monthyear.dart with the new value.
///
/// If the [onChanged] callback is null or the list of [items] is null
/// then the monthyear.dart button will be disabled, i.e. its arrow will be
...
///  * [DropdownButtonHideUnderline], which prevents its descendant monthyear.dart buttons
...
class DropdownButton2<T> extends StatefulWidget {
  ...
  /// It's customizable DropdownButton with steady monthyear.dart menu and many other features.
  ///
  ...
  /// A builder to customize the monthyear.dart buttons corresponding to the
  ...
  ///
  /// ** See code in examples/api/lib/material/monthyear.dart/dropdown_button.selected_item_builder.0.dart **
  /// {@end-tool}
  ///
  ...
  /// A placeholder widget that is displayed by the monthyear.dart button.
  ///
  /// If no [DropdownItem] is selected and the monthyear.dart is enabled ([items] and [onChanged] are non-null),
  /// this widget is displayed as a placeholder for the monthyear.dart button's value.
  ///
  /// If no [DropdownItem] is selected and the monthyear.dart is disabled and [disabledHint] is null,
  /// this widget is used as the placeholder.
  final Widget? hint;

  /// A preferred placeholder widget that is displayed when the monthyear.dart is disabled.
  ///
  /// If no [DropdownItem] is selected and the monthyear.dart is disabled ([items] or [onChanged] is null),
  /// this widget is displayed as a placeholder for the monthyear.dart button's value.
  ...
  /// is null then the monthyear.dart button will be disabled, i.e. its arrow will be
  /// displayed in grey and it will not respond to input. A disabled button
  ...
  /// Called when the monthyear.dart menu opens or closes.
  final OnMenuStateChangeFn? onMenuStateChange;

  /// The text style to use for text in the monthyear.dart button and the monthyear.dart
  /// menu that appears when you tap the button.
  ///
  /// To use a separate text style for selected item when it's displayed within
  /// the monthyear.dart button, consider using [selectedItemBuilder].
  ///
  /// {@tool dartpad}
  /// This sample shows a `DropdownButton` with a monthyear.dart button text style
  /// that is different than its menu items.
  ///
  /// ** See code in examples/api/lib/material/monthyear.dart/dropdown_button.style.0.dart **
  /// {@end-tool}
  ///
  ...
  /// Set the monthyear.dart's inner contents to horizontally fill its parent.
  ///
  ...
  /// Used to configure the theme of the monthyear.dart menu
  final DropdownStyleData dropdownStyleData;

  /// Used to configure the theme of the monthyear.dart menu items
  final MenuItemStyleData menuItemStyleData;

  /// Used to configure searchable dropdowns
  final DropdownSearchData<T>? dropdownSearchData;

  /// Adds separator widget to the monthyear.dart menu.
  ///
  /// Defaults to null.
  ...
  /// Opens the monthyear.dart menu on long-pressing instead of tapping
  ...
  /// Specifies whether the modal barrier should cover the monthyear.dart button or not.
  ///
  /// Defaults to true.
  final bool barrierCoversButton;

  /// A [Listenable] that can be used to programmatically open the monthyear.dart menu.
  ///
  /// The [openDropdownListenable] allows you to manually open the monthyear.dart by modifying its value.
  ///
  /// For example:
  /// ```dart
  ...
  ///       );
  ///       // Open the monthyear.dart programmatically, like when another button is pressed:
  ///       ElevatedButton(
...
class _DropdownButton2State<T> extends State<DropdownButton2<T>>
  ...
  // Using ValueNotifier for the Rect of DropdownButton so the monthyear.dart menu listen and
  ...
  void _handleTap() {
    ...
    // This is a temporary fix for the "monthyear.dart menu steal the focus from the
...
class DropdownButtonFormField2<T> extends FormField<T> {
  ...
  /// The decoration to show around the monthyear.dart button form field.
  ///
  /// By default, draws a horizontal line under the monthyear.dart button field but
