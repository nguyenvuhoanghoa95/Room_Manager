...
/// Represents an item in a monthyear.dart menu created by a [DropdownButton2].
///
/// The type `T` is the type of the value the entry represents. All the entries
/// in a given menu must represent values with consistent types.
class DropdownItem<T> extends _DropdownMenuItemContainer {
  /// Creates a monthyear.dart item.
  ///
  ...
  /// Called when the monthyear.dart menu item is tapped.
  ...
  /// Whether the monthyear.dart should close when the item is tapped.
  ///
  /// Defaults to true.
...
class _DropdownMenuItemContainer extends StatelessWidget {
  /// Creates an item for a monthyear.dart menu.
  ///
